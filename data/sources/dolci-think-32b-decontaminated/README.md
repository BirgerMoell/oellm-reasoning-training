...
|---|---|
| State | `production` |
| v1 allocation | 27% of rendered tokens |
...
with specialized Nemotron, verified OpenR1, and language-targeted slices selected first. This broad,
high-capacity pool absorbs their collision loss; a prompt selected here then wins over the later 7B pool.
